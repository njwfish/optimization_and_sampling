\begin{tikzpicture}[x=0.70cm,y=0.70cm,>=Stealth]
  ...
  % Gradient descent with a small step size (many small moves).
  ...
  % Gradient descent with a larger step size (faster but oscillatory in the steep direction).
  ...
  % Heavy-ball momentum (same step size as above; velocity smooths oscillations).
  \draw[stat221Green,thick,line join=round]
    (6.0000,2.0000) -- (4.9333,-1.2000) -- (3.5230,-0.8800) -- (2.1915,0.6880) -- (1.1361,0.3712)
    -- (0.4065,-0.3811) -- (-0.0306,-0.1475) -- (-0.2437,0.2053) -- (-0.3069,0.0532) -- (-0.2840,-0.1080)
    -- (-0.2220,-0.0158) -- (-0.1516,0.0556) -- (-0.0894,0.0023);
  \foreach \p in {(6.0000,2.0000),(4.9333,-1.2000),(3.5230,-0.8800),(2.1915,0.6880),(1.1361,0.3712),
    (0.4065,-0.3811),(-0.0306,-0.1475),(-0.2437,0.2053),(-0.3069,0.0532),(-0.2840,-0.1080),
    (-0.2220,-0.0158),(-0.1516,0.0556),(-0.0894,0.0023)}{
    \fill[stat221Green] \p circle (1.35pt);
  }
  ...
  \matrix[
    ...
    \node{\tikz[baseline=-0.6ex]{\draw[stat221Red,thick,densely dotted] (0,0) -- (0.8,0); \fill[stat221Red] (0.4,0) circle (1.1pt);}}; &
      \node[stat221Red,anchor=west]{GD, small step size}; \\
    \node{\tikz[baseline=-0.6ex]{\draw[stat221Blue,thick] (0,0) -- (0.8,0); \fill[stat221Blue] (0.4,0) circle (1.1pt);}}; &
      \node[stat221Blue,anchor=west]{GD, large step size}; \\
    \node{\tikz[baseline=-0.6ex]{\draw[stat221Green,thick] (0,0) -- (0.8,0); \fill[stat221Green] (0.4,0) circle (1.1pt);}}; &
      \node[stat221Green,anchor=west]{heavy-ball momentum}; \\
  };
\end{tikzpicture}
